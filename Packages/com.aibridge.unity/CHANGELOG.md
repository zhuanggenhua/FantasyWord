...
- **IDE automation entry** — direct automation entry for Cursor, GitHub Copilot, Windsurf, Claude Desktop
...
- **Zero external dependencies** — pure stdlib Python CLI, self-contained Unity package
