...
Shader "EquipmentSystem/EquipmentUV"
{
    Properties
    {
        ...
        [Header(Body Layer Sprite Rects)]
        _ClothRect ("Clothing Sprite Rect", Vector) = (0,0,1,1)
        _PantsRect ("Pants Sprite Rect", Vector) = (0,0,1,1)
        _CloakRect ("Cloak Sprite Rect", Vector) = (0,0,1,1)
        _BagRect ("Bag Sprite Rect", Vector) = (0,0,1,1)
        ...
        [Header(Head Layer Sprite Rects)]
        _HairRect ("Hair Sprite Rect", Vector) = (0,0,1,1)
        _FaceAccessoryRect ("Face Accessory Sprite Rect", Vector) = (0,0,1,1)
        _BeardRect ("Beard Sprite Rect", Vector) = (0,0,1,1)
        _HelmetRect ("Helmet Sprite Rect", Vector) = (0,0,1,1)
        _MaskRect ("Mask Sprite Rect", Vector) = (0,0,1,1)
