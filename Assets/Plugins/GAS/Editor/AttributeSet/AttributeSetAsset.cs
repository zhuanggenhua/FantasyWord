...
namespace GAS.Editor
{
    ...
    public class AttributeSetConfig
    {
        ...
        private static IEnumerable AttributeChoices = new DropdownList<string>();
        ...
        [Button("按名称排序")]
        private void SortAttributeNames()
        {
        ...
        {
            var choices = new DropdownList<string>();
    ...
    public class AttributeSetAsset : ScriptableSingleton<AttributeSetAsset>
    {
        ...
        [Button("按名称排序")]
        private void SortAttributeSetConfigs()
        {
        ...
        public void SaveAsset()
        {
            ...
            Debug.Log("[EX] AttributeSetAsset save!");
                        ...
                        [Button(GASTextDefine.BUTTON_GenerateAttributeSetCode)]
