...
namespace GAS.Editor
{
    ...
    public class CatchAreaBox2DInspector:TargetCatcherInspector<CatchAreaBox2D>
    {
        ...
        [BoxGroup] [Delayed] [Label("Rotation")] [OnValueChanged("OnCatcherChanged")]
        public float Rotation;
        
        [BoxGroup] [Delayed] [Label("Detect Layer")] [OnValueChanged("OnCatcherChanged")]
        public LayerMask Layer;
        
        [BoxGroup] [Delayed] [Label("Center Type")] [OnValueChanged("OnCatcherChanged")]
