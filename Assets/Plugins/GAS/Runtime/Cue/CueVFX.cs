...
namespace GAS.Runtime
{
    ...
    {
        [BoxGroup]
        [Label(GASTextDefine.CUE_VFX_PREFAB)]
        public GameObject VfxPrefab;

        [BoxGroup]
        [Label(GASTextDefine.CUE_ATTACH_TO_OWNER)]
        public bool IsAttachToTarget = true;

        [BoxGroup]
        [Label(GASTextDefine.CUE_VFX_OFFSET)]
        public Vector3 Offset;

        [BoxGroup]
        [Label(GASTextDefine.CUE_VFX_ROTATION)]
        public Vector3 Rotation;

        [BoxGroup]
        [Label(GASTextDefine.CUE_VFX_SCALE)]
        public Vector3 Scale = Vector3.one;
        
        [BoxGroup]
        [Label(GASTextDefine.CUE_VFX_ACTIVE_WHEN_ADDED)]
