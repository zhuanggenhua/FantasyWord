...
namespace MackySoft.SerializeReferenceExtensions.Editor
{
    public static class ManagedReferenceContextualPropertyMenu
    {
        ...
        static readonly GUIContent kPasteContent = new("Paste Property");
        static readonly GUIContent kNewInstanceContent = new("New Instance");
        static readonly GUIContent kResetAndNewInstanceContent = new("Reset and New Instance");
