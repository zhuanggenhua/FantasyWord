...
$contractPlaceholderExactPaths = @(
    ...
    "Assets/GameData/EquipmentSystem/Animations/GeneratedClips/SourceSprites/Dwarf",
    "Assets/GameData/EquipmentSystem/Animations/GeneratedClips/SourceSprites/Elf",
    "Assets/GameData/EquipmentSystem/Animations/GeneratedClips/SourceSprites/Goblin",
    "Assets/GameData/EquipmentSystem/Animations/GeneratedClips/SourceSprites/Human",
    "Assets/GameData/EquipmentSystem/Animations/GeneratedClips/SourceSprites/Orc",
