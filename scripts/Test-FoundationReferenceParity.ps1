...
$allowedExtraRuntimePaths = @(
    ...
    "Combat\EffectCommonTypes.cs",
    "Combat\FormalGameplayTagCatalog.cs",
    "Database\DatabaseRegistry.Editor.cs",
    "Database\Abilities\AbilityDescriptionLine.cs",
    "Database\Abilities\FormalGasAbilityDescriptionResolver.cs",
    "Database\Abilities\FormalGasAbilityIdentityResolver.cs",
    "Database\Abilities\FormalGasAbilityRuntimeConfigResolver.cs",
    "Database\Abilities\FormalGasAbilityTimelineExecutionResolver.cs",
    "Database\Characters\CharacterAlterationRule.cs",
    "Database\Elements\ElementReactionDefinition.cs",
    "Database\Elements\TerrainElementStateDefinition.cs",
    "Database\Elements\TerrainSurfacePresentationConfig.cs",
    "Database\Quest\Tasks\KillCharacterTask.cs",
    "Database\Quest\Tasks\TalkToCharacterTask.cs",
    "Database\Save\SpriteReference.cs",
    "Combat\FormalAttributeCatalog.cs",
    "Combat\FormalGameplayEffectDamageBridge.cs",
    "Combat\FormalGameplayEffectDamageHelper.cs",
    "Combat\FormalGameplayEffectDamageSystem.cs",
    "Combat\Gas2DTargetCatchers.cs",
    "Combat\Abilities\AbilityPermissionSettings.cs",
    "Combat\Abilities\AbilityRuntimeExtraState.cs",
    "Combat\Abilities\FormalAbilityInputGateRuntime.cs",
    "Combat\Abilities\FormalAbilityInputGateSettings.cs",
    "Combat\Abilities\Active\TimelineActiveAbility.cs",
    "Combat\Effects\Temporal\TemporalAbilityEffectSupport.cs",
    "Combat\Effects\Temporal\TemporalAbilityGrantEffect.cs",
    "Combat\Effects\Temporal\TemporalAbilityReplacementEffect.cs",
    "Combat\Effects\Temporal\TemporalAbilitySuppressionEffect.cs",
    "Combat\GAS\TaskApplyWorldElement.cs",
    "Commands\GameCommandContext.cs",
    "Controllers\IPlayerInputTarget.cs",
    "Controllers\PlayerCommandRequest.cs",
    "Controllers\PlayerControlGroup.cs",
    "Controllers\PlayerControlGroupSnapshot.cs",
    "Controllers\PlayerOrderRequest.cs",
    ...
    "Controllers\CharacterSteeringPathCursor2D.cs",
    "Controllers\CharacterSteeringRuntime2D.cs",
    "Controllers\PlayerController.InteractionRuntime.cs",
    "Controllers\PlayerController.NavigationRuntime.cs",
    "Debug\ClickMoveTestControlPanel.cs",
    "Entities\Characters\CharacterBase.ActionStateRuntime.cs",
    "Entities\Characters\CharacterBase.Alterations.cs",
    ...
    "Entities\Characters\CharacterActor.cs",
    "Entities\Characters\CharacterActor.Quest.cs",
    "Entities\Characters\CharacterActor.Rewards.cs",
    "Entities\Characters\CharacterActor.Sheet.cs",
    "Entities\Characters\CharacterButtonActivation.cs",
    "Entities\Characters\CharacterCommandExecutor.cs",
    "Entities\Characters\CharacterEquipment.cs",
    "Entities\Characters\CharacterEquipmentSlotChange.cs",
    "Entities\Characters\CharacterEquippedItemLoadout.cs",
    "Entities\Characters\CharacterHandleWeapon.cs",
    "Entities\Characters\CharacterInventory.cs",
    "Entities\Characters\CharacterMovement.cs",
    "Entities\Characters\CharacterPlayerControl.cs",
    "Entities\Characters\EPlayerMovementControlMode.cs",
    ...
    "Game\FormalAbilityRuntimeBootstrap.cs",
    "Game\GameManager.LifecycleRuntime.cs",
    "Game\GameManager.SystemRegistryRuntime.cs",
    "Game\Systems\ElementReactionSystem.cs",
    "Game\Systems\InputSystem.Contracts.cs",
    "Game\Systems\InventoryTransferRequest.cs",
    ...
    "Game\Systems\TerrainSurfaceDamageSystem.cs",
    "Interactions\IInteractionReceiver.cs",
    "Elements\ElementContracts.cs",
    "Elements\ElementReactionResolver.cs",
    "Maps\TerrainCellRuntimeState.cs",
    "Maps\TerrainDestinationResolver.cs",
    "Maps\TerrainNavigationGraph.cs",
    "Maps\TerrainNavigationLayerSource.cs",
    "Maps\TerrainNavigationMap.cs",
    "Maps\TerrainNavigationRuntimePathDebugView.cs",
    "Maps\TerrainNavigationTile.cs",
    "Maps\TerrainSurfaceLayerSource.cs",
    "Maps\TerrainTransitionLink.cs",
    "Mods\ModAPI.cs",
    "Mods\ModConfig.cs",
    "Mods\ModInfo.cs",
    "Mods\ModLoader.cs",
    "Mods\ModState.cs",
    "Mods\ModValidator.cs",
    "Physics\IMovableCollisionReceiver.cs",
    "Persistence\Persistable.Contracts.cs",
    "Persistence\Persistable.DataBlocks.cs",
    "Presentation\CuePlayGameCoreAnimator.cs",
    "Presentation\CuePlayGameCoreAudio.cs",
    "Presentation\CuePlayGameCoreFeedback.cs",
    "Presentation\EquipmentVisualAsset.cs",
    "Presentation\FlamethrowerCueVisual.cs",
    "Presentation\GameplayFeedbackSet.cs",
    "Presentation\ICharacterAnimationDriver.cs",
    "Presentation\PlayerCameraRig.cs",
    "Presentation\TerrainSurfacePresentation.cs",
    "Presentation\TerrainSpriteSheetAnimatedTile.cs",
    "Resources\Generated\FWRes.g.cs",
    "Resources\Generated\FWScene.g.cs",
    "Resources\Generated\FWText.g.cs",
    "Resources\ResourceCache.cs",
    "Resources\ResourceHandle.cs",
    "Resources\ResourceSystem.cs",
    "Resources\SoftAssetReference.cs",
    "Resources\SparseArray.cs",
    "Resources\Annotations\AssetReferenceConstraintAttribute.cs",
    "Spawners\ACharacterSpawner.cs",
    "Spawners\CharacterAreaSpawner.cs",
    "Spawners\CharacterSpawner.cs",
    ...
    "Entities\Characters\CharacterAbilitySet.cs",
    "Entities\Characters\CharacterAbilitySet.FormalRules.cs",
    "Entities\Characters\CharacterEquippedAbilityLoadout.cs",
    "Entities\Characters\FormalAbilitySystemAttributeExtensions.cs",
    ...
    "Utilities\ZipArchiveExtractor.cs",
    ...
    "UI\Menus\Character\CharacterMenuContext.cs",
    "UI\Menus\Inventory\IInventoryBagItemClickHandler.cs",
    "UI\Menus\Inventory\InventoryMenuContext.cs",
    "UI\Menus\MenuFeedbackPrompts.cs",
    ...
    "UI\UIPlayerControlFeedback.cs",
    "UI\UITipsItem.cs",
    "UI\UITipsService.cs"
)
$allowedExtraEditorPaths = @(
    "TerrainNavigationMapEditor.cs",
    "Bridge\BridgePollerRecovery.cs",
    "Bridge\FormalSceneInputRootAutomation.cs",
    "Bridge\CharacterEquipmentRuntimeSmokeValidator.cs",
    "Bridge\ClickMoveTestContextSteeringValidator.cs",
    "Bridge\ClickMoveTestContextSteeringWaypointValidator.cs",
    "Bridge\ClickMoveTestElementSurfaceValidator.cs",
    "Bridge\ClickMoveTestElementSurfaceVisualValidator.cs",
    "Bridge\ClickMoveTestGasBasicAttackValidator.cs",
    "Bridge\ClickMoveTestPostAttackChaseValidator.cs",
    "Bridge\ClickMoveTestRuntimeValidator.cs",
    "Bridge\CompositeRuntimeSmokeValidator.cs",
    "Bridge\ContextSteering2DPerformanceBenchmark.cs",
    "Bridge\FormalSceneCameraAudit.cs",
    "Bridge\UIKitSmoke\UIKitSmokeValidator.cs",
    "ContextSteering\ContextSteeringDebugWindow.cs",
    "Editors\CharacterSheetEditor.cs",
    "Editors\CharacterSheetFeedbackEditorUtility.cs",
    "EditorWindows\ContentBrowserWindow.cs",
    "GAS\GasTimelineHitboxSceneHandle.cs",
    "Generated\FWSceneMenu.g.cs",
    "Generated\SceneMenuRegistry.cs",
    "PropertyDrawers\UIKitMenuPanelTypeReferencePropertyDrawer.cs",
    "Tests\ContextSteering2DEditModeTests.cs",
    "Tests\ElementReactionCoreEditModeTests.cs",
    "Tests\ElementReactionSystemEditModeTests.cs",
    "Tests\FormalAttributeSingleSourceEditModeTests.cs",
    "Tests\FormalDamagePipelineEditModeTests.cs",
    "Tests\GasEditModeTestHelper.cs",
    "Tests\InventorySystemTransactionEditModeTests.cs",
    "Tests\MeleeAttackAbilityEditModeTests.cs",
    "Tests\TaskApplyWorldElementEditModeTests.cs",
    "Tests\TerrainNavigationMapEditModeTests.cs",
    "Tests\TerrainSurfaceDamageSystemEditModeTests.cs",
    "Utils\FormalAbilityAssetValidation.cs",
...
$allowedPatchedRuntimePaths = @(
    ...
    "Animation\Strategies\PolydirectionalAnimationStrategy.cs",
    "Animation\TransformShaker.cs",
    ...
    "Commands\AddOrRemoveItem.cs",
    "Commands\AddOrRemoveMana.cs",
    "Commands\AddOrRemoveMoney.cs",
    "Commands\ApplyEffectsToPlayer.cs",
    "Commands\CloseMenus.cs",
    "Commands\CompleteTask.cs",
    "Commands\DestroyEntity.cs",
    "Commands\ExecuteCommandHandler.cs",
    "Commands\ExecuteCommandIf.cs",
    "Commands\ExecuteCommandList.cs",
    "Commands\HealOrDamagePlayer.cs",
    "Commands\ICommand.cs",
    "Commands\MakeQuestAvailable.cs",
    "Commands\MoveCamera.cs",
    "Commands\MoveCharacter.cs",
    "Commands\MoveCharacterBase.cs",
    ...
    "Commands\RespawnPlayer.cs",
    "Commands\RevivePlayer.cs",
    "Commands\SaveCheckpoint.cs",
    "Commands\SetGameFlag.cs",
    "Commands\ToggleController.cs",
    "Commands\Wait.cs",
    "Conditional\Conditions\ABaseCondition.cs",
    "Conditional\Conditions\AreConditionsMet.cs",
    ...
    "Controllers\AController.cs",
    "Controllers\AIController.cs",
    "Controllers\IController.cs",
    "Database\AssetMenuIndexer.cs",
    "Database\DatabaseEntry.cs",
    ...
    "Database\Items\ItemEffects\IItemEffect.cs",
    "Database\Items\ItemEffects\ItemAddAbilityEffect.cs",
    "Database\Items\ItemEffects\ItemCleanseEffect.cs",
    ...
    "Database\Items\ItemEffects\ItemStartQuestEffect.cs",
    ...
    "Conditional\StateMachines\AConditionalStateMachine.cs",
    ...
    "Interactions\ChestInteraction.cs",
    ...
    "UI\Effects\UIEffectDescription.cs",
    ...
    "UI\Menus\Craft\UIIngredientEntry.cs",
    ...
    "UI\Menus\Inventory\UIInventoryEquipment.cs",
...
$allowedPatchedEditorPaths = @(
    ...
    "PropertyDrawers\MapSelectorPropertyDrawer.cs",
...
$excludedRuntimeReferencePaths = @(
    ...
    "Combat\EffectDispatcher.cs",
    "Combat\ObservableStats.cs",
    "Combat\Abilities\Ability.cs",
    "Combat\Abilities\Active\DashAbility.cs",
    "Combat\Abilities\Active\ActiveAbility.cs",
    ...
    "Combat\Abilities\Passive\PassiveAbility.cs",
    "Combat\Abilities\Passive\PassiveAbilityBase.cs",
    "Combat\Abilities\Passive\TickingAbility.cs",
    "Combat\Effects\Immediate\AImmediateEffect.cs",
    "Combat\Effects\Immediate\ImmediateDamageEffect.cs",
    "Combat\Effects\Immediate\ImmediateHealEffect.cs",
    "Combat\Effects\Immediate\ImmediateRestoreManaEffect.cs",
    "Commands\ApplyEffectsToPlayer.cs",
    ...
    "Entities\Characters\NPC.cs",
    "Spawners\AMonsterSpawner.cs",
    "Spawners\MonsterAreaSpawner.cs",
    "Spawners\MonsterSpawner.cs",
    "UI\UIPlayerControllerFeedback.cs",
    "UI\Menus\AUIMenu.cs",
    "UI\Menus\IUIMenu.cs",
...
$excludedEditorReferencePaths = @(
    "Diagnostics\ReferenceCapture\TwoDRpgReferenceCaptureBridge.cs",
    "Editors\AbilitySheetEditor.cs",
    "Editors\HeroSheetEditor.cs",
    "Editors\MonsterSheetEditor.cs",
    "Playtest\EditorPlayModeOverride.cs",
